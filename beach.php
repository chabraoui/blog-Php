...
<body>
  ...
  <li class="nav-item  mr-xm-2"><a class="nav-link" href="home.php" id="a">HOME</a></li>
							<li class="nav-item mr-xl-2"><a class="nav-link" href="beach.php" id="b"  style="color:#FF007F" >BEACH</a></li>
									<li class="nav-item mr-xl-1"><a class="nav-link" href="hotel.php" id="c" >HOTELS</a></li>
									<li class="nav-item submenu dropdown">
										<a class="nav-link  mr-xm-1" id="d" href="lieux.php" >LIEUX</a>
									</li>
									<li>
										<?php
  		...
  		<div class="container">
  			...
  			<div class="row">
  				<!-- single-feature -->
					...
					<?php
		    $sql = "SELECT * FROM articles where id_cat=9";
		    $q = $cnx->query($sql);
																		...
																		<div class="modal-dialog">
																			<div class="modal-content">
																				...
																				<div class="modal-title">
																					...
																					<img class="card-img-top" src="<?php echo htmlspecialchars("images/".$row['image']); ?>" alt="erreur" height="300px">
																					</div>
																					<div class="modal-body">
...
<form method="post" class="form" action ="addcomment.php"  enctype="multipart/form-data">
							...
							<div>
								<br>
							<input type="submit" name="enregistrer" class="btn btn-secondary" value="affiche comment" data-toggle="modal" data-target="#loginModale<?php echo  $row['id'];?>">
							<div class="table-responsive">
													...
													<?php
															$art_id=$row['id'];
															$affich_com = $cnx->prepare("SELECT utilisateur.Nom, utilisateur.Prenom,commentaires.id, commentaires.id_article, commentaires.Text,articles.id, commentaires.date_Ajoute, utilisateur.id_utilisateur FROM commentaires
...
?>
<form method="post" action="supprimer.php?d_id=<?php echo $don['id'] ;?>">
                  <button  type="submit" name="suprimer" class="far fa-trash-alt"></button>
								<?php } else{ ?><button  type="submit" name="suprimer" class="far fa-trash-alt" disabled> </button>
								<?php }	?>
</form>
