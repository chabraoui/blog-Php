...
<body>
	...
	<header class="header_area">
		<div class="main_menu">
		  ...
		  <li class="nav-item  mr-xm-2"><a class="nav-link" href="home.php" id="a">HOME</a></li>
              		...
              		<li class="nav-item mr-xl-1"><a class="nav-link" href="hotel.php" id="c" style="color:#FF007F" >HOTELS</a></li>
    ...
    <section class="package-area section_gap_top">
  		<div class="container">
  			...
  			<div class="row">
          <?php
        $sql = "SELECT * FROM articles where id_cat=14";
        $q = $cnx->query($sql);
        $q->setFetchMode(PDO::FETCH_ASSOC);
           ?>
              ...
              $m = $tab2[1];
              $d = $tab2[2];
              $months = ['Janvier', 'Fevrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novombre', 'Dececembre'];
              $m = $months[$m - 1];
              ?>
  				<div class="col-lg-4 col-md-6">
  					<div class="single-package">
  						<div class="thumb">
  							<img class="img-fluid" src="<?php echo htmlspecialchars("images/".$row['image']); ?>" alt="">
  						</div>
  						<p class="date"><span><?php echo $d ?></span> <br> <?php echo $m ?></p>
              ...
              <form method="post" class="form" action ="addcomment3.php"  enctype="multipart/form-data">
              							...
              							<div class="aaz">
              								...
              								<input type="submit" name="envoyer" class="btn btn-sub btn-success" value="envoyer" href="hotel.php">
                          ...
                          ?>
                                ...
                                if( isset( $_SESSION["membre"]) &&  $_SESSION['membre']!==false && (($don["Nom"] == $_SESSION["nom"] && $don["Prenom"] == $_SESSION["prenom"] && $_SESSION["id_user"]==$don['id_utilisateur']) || $_SESSION["Admin"]==1) ){
                                    ...
                                    ?>
                                      ...
                                      <form method="post" action="supprimer2.php?d_id=<?php echo $don['id'] ;?>">
                                                      <button  type="submit" name="suprimer2" class="far fa-trash-alt"></button>
                                                    <?php } else{ ?><button  type="submit" name="suprimer2" class="far fa-trash-alt" disabled> </button>
                                                    <?php }	?>
                                    </form>
                                                                                  </td>
                                            </tr>
